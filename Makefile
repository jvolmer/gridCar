...
$(BIN_DIR)/communication/messageToCar.test: $(BUILD_DIR)/communication/messageToCar_test.o $(BUILD_DIR)/communication/messageToCar.o $(BUILD_DIR)/movement/position/coordinate.o $(BUILD_DIR)/movement/position/coordinate_ostream.o |$$(@D)/.f
...
$(BIN_DIR)/movement/linePilot.test: $(BUILD_DIR)/movement/linePilot_test.o $(BUILD_DIR)/movement/linePilot.o $(BUILD_DIR)/movement/stop.o $(BUILD_DIR)/movement/followLine.o $(BUILD_DIR)/movement/turnRightFromLine.o $(BUILD_DIR)/movement/alignInRightTurn.o $(BUILD_DIR)/movement/turnRightToLine.o $(BUILD_DIR)/movement/turnLeftFromLine.o $(BUILD_DIR)/movement/alignInLeftTurn.o $(BUILD_DIR)/movement/turnLeftToLine.o $(BUILD_DIR)/movement/position/coordinate.o $(BUILD_DIR)/movement/position/coordinate_ostream.o $(BUILD_DIR)/communication/coordinateListener.o |$$(@D)/.f
