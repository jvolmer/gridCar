...
$(BIN_DIR)/movement/followLine.test: $(BUILD_DIR)/movement/followLine_test.o $(BUILD_DIR)/movement/followLine.o $(BUILD_DIR)/movement/stop.o $(BUILD_DIR)/movement/position/coordinate.o |$$(@D)/.f
